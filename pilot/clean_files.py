...
folder_range = range(11)  # 0 to 10 inclusive

# Define the folders and files to keep
folders_to_check = ['baseline', 'cognitive_load']
files_to_keep = {
...
for folder_number in folder_range:
    ...
    # Iterate over each sub-folder (baseline and cognitive_load)
